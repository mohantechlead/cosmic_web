            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="orders_related_to_customer",
                        to="users.customer_profile",
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        blank=True,
                        db_column="notify_party",
                        null=True,
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="notify_party_one",
                        to="users.customer_profile",
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        blank=True,
                        db_column="notify_party2",
                        null=True,
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="orders_related_to_bank",
                        to="users.customer_profile",
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="orders_related_to_supplier",
                        to="users.supplier_profile",
                    ),
                ),
            ],
        ),
